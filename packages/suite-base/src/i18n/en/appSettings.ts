...
export const appSettings = {
  ...
  dark: "Dark",
  debugModeDescription: "Enable panels and features for debugging Visualizer",
  ...
  syncLichtblickInstances: "Sync Visualizer instances",
  syncLichtblickInstancesDescription:
    "Activates the button in the right lower corner of the application to sync Visualizer instances opened.",
